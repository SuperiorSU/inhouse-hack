    ...
    <div className='relative bg-gradient-to-b from-[#04081a] via-[#231451] to-[#04081a] p-7'>
        ...
        <div className='grid grid-cols-2 py-7 gap-5'>
            ...
            <div className='col-span-2 lg:col-span-1 md:col-span-2 sm:col-span-2 p-5 relative z-[2] my-auto'>
                <h3 className='text-3xl lg:text-start md:text-center sm:text-center text-center lg:text-7xl sm:text-5xl md:text-5xl text-white ps-3 font-bold uppercase'>Collaborate</h3>
                <br></br>
                <p className='text-gray-400 text-[15px] lg:text-start md:text-center sm:text-center text-center ps-3'>Build your own projects and learn from theme. Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
        ...
        <div className='grid grid-cols-2 py-7 gap-5'>
            ...
            <div className='col-span-2 lg:col-span-1 md:col-span-2 sm:col-span-2 p-5 relative z-[2] my-auto lg:order-1 md:order-2 sm:order-2 order-2'>
                <h3 className='text-3xl lg:text-end md:text-center sm:text-center text-center lg:text-7xl sm:text-5xl md:text-5xl text-white ps-3 font-bold uppercase '>THINK</h3>
                <br></br>
                <p className='text-gray-400 text-[15px] ps-3 lg:text-end md:text-center sm:text-center text-center'>Build your own projects and learn from theme. Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                <div className='absolute lg:left-96 -top-16 text-[188px] font-bold text-white/10 text-end'>
                    02
                </div>
            </div>
            <div className='col-span-2 lg:col-span-1 md:col-span-2 sm:col-span-2 lg:order-2'>
        ...
        <div className='grid grid-cols-2 py-7 gap-5'>
            ...
            <div className='col-span-2 lg:col-span-1 md:col-span-2 sm:col-span-2 p-5 relative z-[2] my-auto'>
                <h3 className='text-3xl lg:text-start md:text-center sm:text-center text-center lg:text-7xl sm:text-5xl md:text-5xl text-white ps-3 font-bold uppercase'>CReate</h3>
                <br></br>
                <p className='text-gray-400 text-[15px] ps-3 lg:text-start md:text-center sm:text-center text-center'>Build your own projects and learn from theme. Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                <div className='absolute -top-16 text-[188px] font-bold text-white/10'>
                    03
                </div>
            </div>
